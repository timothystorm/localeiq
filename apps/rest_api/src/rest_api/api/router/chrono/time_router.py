...
from rest_api.service.chrono.chrono_service import (
    TimeService,
    to_valid_timezone,
)
...
async def get_current_time(tz: str | None = None) -> DateTimeResponse:
    """
    ...
    try:
        ...
        now = TimeService().now(tz=valid_timezone)
